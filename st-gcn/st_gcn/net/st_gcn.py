...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        print("in channels of fcn is {}".format(backbone_out_c))
        print("out channels of fcn is {}".format(num_class))
    ...
    def forward(self, x):
        ...
        #print("-------forward to fcn ....")
        # C fcn
        #x = self.fcn(x)
        #print("x.size: is {}".format(x.size()))
        # print("N is {}".format(N))
        #x = F.avg_pool1d(x, x.size()[2:]) # in case of multiple persons.
